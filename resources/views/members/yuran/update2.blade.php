	...
	<div class="col-xs-6">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				{!! Form::model($yuran, ['route' => ['updateYuranPost', $yuran->id]]) !!}
				<table class="table">
					...
					<div class="input-group">
						...
						{!! Form::number('jumlah', number_format($yuran->jumlah, 2), ['required' => 'true', 'class' => 'form-control', 'step' => '0.01', 'placeholder' => '0.00']) !!}
					</div>
					</div>
